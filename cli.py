...
def main():
    ...
    run_parser.add_argument("--force", action="store_true", help="Force rerun of completed stages")
    run_parser.add_argument("--config", default="config.yaml", help="Configuration file")
    
    # Reset command
    reset_parser = subparsers.add_parser("reset", help="Reset pipeline state")
    reset_parser.add_argument("--stages", nargs="*", help="Stages to reset (default: all)")
    reset_parser.add_argument("--config", default="config.yaml", help="Configuration file")
    
    # Status command
    status_parser = subparsers.add_parser("status", help="Show pipeline status")
    status_parser.add_argument("--config", default="config.yaml", help="Configuration file")
